...
[![Ubuntu daily 1.2 build status](https://jenkins.nordix.org/buildStatus/icon?job=metal3_daily_release-1-2_integration_test_ubuntu&subject=Ubuntu%20daily%201.2)](https://jenkins.nordix.org/view/Metal3/job/metal3_daily_release-1-2_integration_test_ubuntu/)
[![CentOS daily 1.2 build status](https://jenkins.nordix.org/buildStatus/icon?job=metal3_daily_release-1-2_integration_test_centos&subject=CentOS%20daily%201.2)](https://jenkins.nordix.org/view/Metal3/job/metal3_daily_release-1-2_integration_test_centos/)
