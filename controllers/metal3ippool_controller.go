...
func (r *Metal3IPPoolReconciler) Reconcile(req ctrl.Request) (_ ctrl.Result, rerr error) {
	...
	ipamv1IPPool := &ipamv1.Metal3IPPool{}
	...
	// Always patch ipamv1IPPool exiting this function so we can persist any Metal3IPPool changes.
	defer func() {
...
func (r *Metal3IPPoolReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&ipamv1.Metal3IPPool{}).
		Watches(
			&source.Kind{Type: &ipamv1.Metal3IPClaim{}},
...
func (r *Metal3IPPoolReconciler) Metal3IPClaimToMetal3IPPool(obj handler.MapObject) []ctrl.Request {
	if m3ipc, ok := obj.Object.(*ipamv1.Metal3IPClaim); ok {
