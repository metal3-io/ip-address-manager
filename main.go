...
func setupReconcilers(ctx context.Context, mgr ctrl.Manager) {
	if err := (&controllers.IPPoolReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "IPPoolReconciler for IPClaims")
		os.Exit(1)
	}
	...
	if err := (&controllers.IPPoolReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "IPPoolReconciler for IPAddressClaim")
		os.Exit(1)
	}
}
