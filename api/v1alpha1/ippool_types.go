...
type IPPoolStatus struct {
	...
	// /64 or larger), Capacity is reported as the int64 maximum and
	// CapacityCapped is set to true. If the pools cannot be sized at all,
	// Capacity is omitted.
	// +optional
	...
	// (see Capacity and CapacityCapped).
	// +optional
	AvailableIPCount *int64 `json:"availableIPCount,omitempty"`

	// CapacityCapped is true when the combined size of the pools is too large
	...
	// +optional
	CapacityCapped bool `json:"capacityCapped,omitempty"`
}
...
// +kubebuilder:printcolumn:name="Capacity Capped",type="boolean",JSONPath=".status.capacityCapped",description="Whether the pool capacity is too large to count exactly and has been capped"
